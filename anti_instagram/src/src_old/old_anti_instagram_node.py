#!/usr/bin/env python
import rospy
<<<<<<< HEAD:catkin_ws/src/10-lane-control/anti_instagram/src/anti_instagram_node.py
import numpy as np
...
import duckietown_utils as dtu, image_cv_from_jpg
...
class AntiInstagramNode(object):
    ...
    def cbNewImage(self,image_msg):
        ...
        if self.image_pub_swit<<<<<<< HEAD:catkin_ws/src/10-lane-control/anti_instagram/src/anti_instagram_node.pych:
